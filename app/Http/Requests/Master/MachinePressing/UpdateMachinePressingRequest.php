...
class UpdateMachinePressingRequest extends BaseApiRequest
{
    ...
    {
        return [
            'machine_code'          => ['required', 'string', 'max:10', Rule::unique('machine_pressing','machine_code')
                                            ->ignore($this->machine_code, 'machine_code')],
            ...
            'machine_status_code'   => ['required', 'string', 'exists:machine_status,status_code'],
